...
import com.anangkur.beritaku.core.util.Const.LABEL_CLIPBOARD
...
fun Spinner.setupSpinner(data: ArrayList<String>, listener: com.anangkur.beritaku.core.base.BaseSpinnerListener){
...
fun Context.showDialogImagePicker(listener: com.anangkur.beritaku.core.base.DialogImagePickerActionListener) {
