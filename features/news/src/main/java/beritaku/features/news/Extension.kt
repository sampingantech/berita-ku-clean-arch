...
fun Spinner.setupSpinner(data: ArrayList<String>, listener: beritaku.features.news.base.BaseSpinnerListener){
...
fun Context.showDialogImagePicker(listener: beritaku.features.news.base.DialogImagePickerActionListener) {
